...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = _react2.default.createClass({
	  ...
	  renderUserActionComp: function renderUserActionComp() {
	    if (loginUser && loginUser.id) {
	      return _react2.default.createElement(
	        'div',
	        { className: 'ui pointing dropdown link item', ref: 'user_action' },
	        _react2.default.createElement(
	          'span',
	          { className: 'text' },
	          loginUser.name
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('img', { className: 'logo', width: '32', height: '32', src: 'static/res/img/logo.png' })
	        ),
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { to: '/', className: 'header item' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Alert = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var className = 'ui ' + colorDict[this.state.type] + ' compact message';
	    return _react2.default.createElement(
	      'div',
	      { className: className, style: display, id: 'custom_alert' },
	      _react2.default.createElement(
	        'p',
	        null,
	        this.state.tip
